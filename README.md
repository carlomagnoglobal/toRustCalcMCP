...
- **283 builtins** (81% of calc's ~350) organized by category — see implementation status below.
...
## Implementation Status — 283 of ~350 builtins (81% coverage)

calc upstream has ~350 builtins. This port implements **283 core functions** organized by category:
