...
- **269 builtins** (77% of calc's ~350) organized by category — see implementation status below.
...
## Implementation Status — 269 of ~350 builtins (77% coverage)

calc upstream has ~350 builtins. This port implements **269 core functions** organized by category:
