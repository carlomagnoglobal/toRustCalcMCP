...
- Full calc functionality (all 356 builtins)
...
- **356 builtins** (100%+ of calc's ~350) organized by category — see implementation status below.
...
## Implementation Status — 356 of ~350 builtins (100%+ coverage) ✅ COMPLETE
