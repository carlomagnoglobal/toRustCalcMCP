...
- **244 builtins** (70% of calc's ~350) organized by category — see implementation status below.
...
## Implementation Status — 244 of ~350 builtins (70% coverage)

calc upstream has ~350 builtins. This port implements **244 core functions** organized by category:
